...
such as method descriptions and parameter names (as these are not stored in compiled code).
...
## Dependencies
Torch uses [kirjava](https://github.com/notiska/kirjava) to analyse Java files,
